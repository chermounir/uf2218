...
<div class="container">
 <div class="row">
	      ...
	      <a href="backoffice/videos?op=<%=VideoController.OP_NUEVO%>" class="btn btn-primary mb-2 btn-block">Nuevo Video</a>
	      </div>
 </div>
  ...
  <div class="row">
      <c:forEach items="${videos}" var="video">
	      ...
	      <a href="backoffice/videos?op=<%=VideoController.OP_DETALLE%>&id=${video.id}"  class="btn btn-info mb-2 btn-block">DETAILLE</a></span>
	      </div>
      </c:forEach>

...
public class VideoDAO {
	...
	*/
	public boolean modificar(Video pojo) throws MysqlDataTruncation, MySQLIntegrityConstraintViolationException {
		boolean resultado = false;
	...
	public boolean crear(Video pojo) throws MySQLIntegrityConstraintViolationException, MysqlDataTruncation {
		boolean resultado = false;
